...
2021-Oct-21 - Written by Douglas Finkbeiner, CfA \\
"""
function gspice_gp_interp(Dvec, covmat; irange=nothing, nguard=20, bruteforce=false)
...
2021-Oct-21 - Written by Douglas Finkbeiner, CfA \\
"""
function gspice_covar_iter_mask(flux, ivar, mask; nsigma=[20, 8, 6], maxbadpix=64)
